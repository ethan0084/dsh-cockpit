...
description: Install, update, verify, or start DeepSeek Harness with the public DSH Cockpit plugin from npm. Use when a user asks to install DSH, install DSH Cockpit, set up the DSH web profile, replace an old private DSH restore workflow, or verify a public installation. Installs DSH 0.1.0-rc.6 and dsh-cockpit 0.2.4 without migrating sessions, settings, projects, credentials, a desktop shell, or patched dependency files.
---
